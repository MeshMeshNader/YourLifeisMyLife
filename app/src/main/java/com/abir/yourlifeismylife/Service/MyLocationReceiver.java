package com.abir.yourlifeismylife.Service;
...
public class MyLocationReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION = "com.abir.yourlifeismylife.UPDATE_LOCATION";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        uid = Paper.book().read(Common.USER_UID_SAVED_KEY);
        if (intent != null) {
